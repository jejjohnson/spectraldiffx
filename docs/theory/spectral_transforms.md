...
![DST-I (sine) and DCT-II (cosine) basis functions for N=8. DST-I modes vanish at the boundaries (Dirichlet), while DCT-II modes have zero slope (Neumann).](../images/theory_figures/basis_functions.png)
...
![Discrete finite-difference eigenvalues (blue circles) vs continuous eigenvalues (red squares) for N=32. The two agree for low wavenumbers but diverge near the Nyquist frequency.](../images/theory_figures/eigenvalues_comparison.png)
