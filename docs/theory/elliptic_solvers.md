...
![Eigenfunction recovery test: the DST-I Poisson solver recovers the exact eigenfunction to machine precision.](../images/theory_figures/eigenfunction_recovery.png)
