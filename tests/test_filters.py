...
@pytest.fixture
def grid1d(): return FourierGrid1D.from_N_L(64, 2 * jnp.pi)


@pytest.fixture
def grid2d(): return FourierGrid2D.from_N_L(32, 32, 2 * jnp.pi, 2 * jnp.pi)


@pytest.fixture
def grid3d(): return FourierGrid3D.from_N_L(16, 16, 16, 2 * jnp.pi, 2 * jnp.pi, 2 * jnp.pi)
